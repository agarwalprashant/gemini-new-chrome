...
class GeminiLiveSession {
  ...
  async connect() {
    ...
    try {
      ...
      const wsUrl = `wss://generativelanguage.googleapis.com/ws/google.ai.generativelanguage.${this.apiVersion}.GenerativeService.BidiGenerateContent?key=${this.apiKey}`;
  ...
  sendSetupMessage() {
    ...
    const setupMessage = {
      setup: {
        ...
        systemInstruction: {
          parts: [{
            text: "You are a helpful AI assistant with access to live audio and screen capture. Respond naturally to voice input and Explain concepts in simple everyday english step-by-step from first principles.Dont Just repeat what is said in the input. Use the screen capture to provide contextually relevant answers. Keep responses concise and to the point."
          }]
        },
